...
//
//    public TrainController(TrainServiceImpl trainServiceImpl, TrainImageService trainImageService) {
...
//
//
//        PagedResponse<TrainDTO> allTrains = trainServiceImpl.getAllTrains(page, size, sortBy, sortDir);
//        return new ResponseEntity<>(allTrains, HttpStatus.OK);
//    }
//
//    @GetMapping("/{trainId}")
//    public ResponseEntity<TrainDTO> getTrainById(@PathVariable Long trainId) {
//        return new ResponseEntity<>(trainServiceImpl.getTrain(trainId),HttpStatus.OK);
//    }
//
...
//    return new ResponseEntity<>(trainServiceImpl.createTrain(trainDTO), HttpStatus.CREATED);
//  }
//
//
//
...
//    public ResponseEntity<Resource> serveTrainImage(@PathVariable Long trainId) throws MalformedURLException {
