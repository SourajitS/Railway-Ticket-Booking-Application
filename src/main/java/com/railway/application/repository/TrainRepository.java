...
//            SELECT tr
//            FROM TrainRoute tr
//            WHERE tr.station.id = :sourceStationId
//               OR tr.station.id = :destinationStationId
//            GROUP BY tr.train.id
//            HAVING
//              SUM(CASE WHEN tr.station.id = :sourceStationId THEN 1 ELSE 0 END) > 0
//              AND
//              SUM(CASE WHEN tr.station.id = :destinationStationId THEN 1 ELSE 0 END) > 0
//              AND
//              (
//                MIN(CASE
//                      WHEN tr.station.id = :sourceStationId
//                      THEN tr.stationOrder
//                      ELSE 999999
//                    END)
//                <
//                MIN(CASE
//                      WHEN tr.station.id = :destinationStationId
//                      THEN tr.stationOrder
//                      ELSE 999999
//                    END)
//              )
